        ...
        <div class="max-w-[1280px] mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                ...
                <div>
                    ...
                    <p class="text-gray-400 text-sm mb-6">Your Professional Ticketing Partner</p>
                    
                    {{-- Social Media Icons --}}
                    <div class="flex items-center gap-3">
                        <a href="#" class="w-10 h-10 rounded-full bg-white/5 hover:bg-[#F5C518]/20 border border-white/5 hover:border-[#F5C518]/30 flex items-center justify-center text-gray-400 hover:text-[#F5C518] transition-all">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-400">
                        ...
                        <li><a href="#" class="hover:text-[#F5C518] transition-colors">Kebijakan Privasi</a></li>
                        <li><a href="#" class="hover:text-[#F5C518] transition-colors">Syarat & Ketentuan</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-400">
                        ...
                        <li><a href="#" class="hover:text-[#F5C518] transition-colors">Panduan Event Organizer</a></li>
            ...
            <div class="border-t border-white/10 pt-8 text-center">
                <p class="text-gray-500 text-sm">&copy; 2026 RADJATIKET. Hak Cipta Dilindungi.</p>
            </div>
