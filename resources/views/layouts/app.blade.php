        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
                ...
                <div class="flex items-center gap-3">
                    @if($settings?->social_instagram)
                        <a href="{{ $settings->social_instagram }}" target="_blank" class="w-10 h-10 rounded-full bg-white/5 hover:bg-[#F5C518]/20 border border-white/5 hover:border-[#F5C518]/30 flex items-center justify-center text-gray-400 hover:text-[#F5C518] transition-all">
                    ...
                    @if($settings?->social_tiktok)
                        <a href="{{ $settings->social_tiktok }}" target="_blank" class="w-10 h-10 rounded-full bg-white/5 hover:bg-[#F5C518]/20 border border-white/5 hover:border-[#F5C518]/30 flex items-center justify-center text-gray-400 hover:text-[#F5C518] transition-all">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 005 20.1a6.34 6.34 0 0010.86-4.43v-7a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1-.1z"/></svg>
                        </a>
                    @endif
                    @if($settings?->social_youtube)
                        <a href="{{ $settings->social_youtube }}" target="_blank" class="w-10 h-10 rounded-full bg-white/5 hover:bg-[#F5C518]/20 border border-white/5 hover:border-[#F5C518]/30 flex items-center justify-center text-gray-400 hover:text-[#F5C518] transition-all">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                        </a>
                    @endif
                    @if($settings?->social_facebook)
                        <a href="{{ $settings->social_facebook }}" target="_blank" class="w-10 h-10 rounded-full bg-white/5 hover:bg-[#F5C518]/20 border border-white/5 hover:border-[#F5C518]/30 flex items-center justify-center text-gray-400 hover:text-[#F5C518] transition-all">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                    @endif
                    @if($settings?->social_twitter)
                        <a href="{{ $settings->social_twitter }}" target="_blank" class="w-10 h-10 rounded-full bg-white/5 hover:bg-[#F5C518]/20 border border-white/5 hover:border-[#F5C518]/30 flex items-center justify-center text-gray-400 hover:text-[#F5C518] transition-all">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                        </a>
                    @endif
                    @if($settings?->social_whatsapp)
                        <a href="https://wa.me/{{ $settings->social_whatsapp }}" target="_blank" class="w-10 h-10 rounded-full bg-white/5 hover:bg-[#F5C518]/20 border border-white/5 hover:border-[#F5C518]/30 flex items-center justify-center text-gray-400 hover:text-[#F5C518] transition-all">
                    ...
                    @forelse($aboutPages as $page)
                        <li>
                            <a href="{{ route('page.show', $page->slug) }}" 
                               class="hover:text-[#F5C518] transition-colors">
                                {{ $page->title }}
                            </a>
                        </li>
                    @empty
                        <li><a href="#" class="hover:text-[#F5C518] transition-colors">Tentang RADJATIKET</a></li>
                        <li><a href="#" class="hover:text-[#F5C518] transition-colors">Hubungi Kami</a></li>
                    @endforelse
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    ...
                    @empty
                        <li><a href="#" class="hover:text-[#F5C518] transition-colors">Cara Membeli Tiket</a></li>
                        <li><a href="#" class="hover:text-[#F5C518] transition-colors">Cara Menjual Tiket</a></li>
                        <li><a href="#" class="hover:text-[#F5C518] transition-colors">FAQ</a></li>
                    @endforelse
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    <li><a href="{{ route('events.index', ['category' => 'musik']) }}" class="hover:text-[#F5C518] transition-colors">Musik</a></li>
                    <li><a href="{{ route('events.index', ['category' => 'festival']) }}" class="hover:text-[#F5C518] transition-colors">Festival</a></li>
                    <li><a href="{{ route('events.index', ['category' => 'seminar']) }}" class="hover:text-[#F5C518] transition-colors">Seminar</a></li>
                    <li><a href="{{ route('events.index', ['category' => 'pameran']) }}" class="hover:text-[#F5C518] transition-colors">Pameran</a></li>
                    <li><a href="{{ route('events.index', ['category' => 'olahraga']) }}" class="hover:text-[#F5C518] transition-colors">Olahraga</a></li>
                    <li><a href="{{ route('events.index', ['category' => 'workshop']) }}" class="hover:text-[#F5C518] transition-colors">Workshop</a></li>
                </ul>
            </div>
