{{--
    RADJATIKET V2 - Notification Toast Component
    ...
    window.dispatchEvent(new CustomEvent('notify', { 
        detail: { type: 'success', message: 'Order created!' }
    }));
--}}
    ...
    <div class="rounded-xl shadow-lg border overflow-hidden"
        ...
        <div class="h-1 bg-gray-100">
            <div class="h-full transition-all duration-5000 ease-linear"
                 ...
                 style="width: 100%;"
                 x-transition:enter="transition-all ease-linear duration-5000"
                 x-transition:enter-start="width: 100%;"
                 x-transition:enter-end="width: 0%;"></div>
        </div>
    </div>
</div>
