                ...
                @else
                    ...
                    @for($i = 1; $i <= 5; $i++)
                        <div class="swiper-slide">
                            <div class="relative w-full aspect-[750/400] md:aspect-[1920/550] bg-gradient-to-br from-gray-100 via-gray-50 to-white flex items-center justify-center">
                                <div class="text-center z-10">
                                    <svg class="w-20 h-20 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                    </svg>
                                    <p class="text-gray-700 text-sm font-semibold">Event Promo {{ $i }}</p>
                                    <p class="text-gray-500 text-xs mt-1">Temukan Event Terbaik di Indonesia</p>
                                </div>
                            </div>
                        </div>
                    @endfor
...
<section class="py-6 border-y border-gray-200">
    <div class="max-w-[1280px] mx-auto px-6">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            
            {{-- Badge 1: 100% Aman --}}
            <div class="flex items-center gap-4 p-5 rounded-2xl bg-white border border-gray-200 shadow-sm">
                ...
                <div>
                    <h4 class="text-gray-900 font-bold text-sm">100% Aman</h4>
                    <p class="text-gray-600 text-xs">Transaksi Terpercaya</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-4 p-5 rounded-2xl bg-white border border-gray-200 shadow-sm">
                ...
                <div>
                    <h4 class="text-gray-900 font-bold text-sm">Mudah & Cepat</h4>
            ...
            <div class="flex items-center gap-4 p-5 rounded-2xl bg-white border border-gray-200 shadow-sm">
                ...
                <div>
                    <h4 class="text-gray-900 font-bold text-sm">E-Ticket Instan</h4>
                    <p class="text-gray-600 text-xs">Langsung ke Email</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-4 p-5 rounded-2xl bg-white border border-gray-200 shadow-sm">
                ...
                <div>
                    <h4 class="text-gray-900 font-bold text-sm">24/7 Support</h4>
                    <p class="text-gray-600 text-xs">Siap Membantu</p>
                </div>
            </div>
